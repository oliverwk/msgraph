...
struct TeamsEvent: Codable {
    ...
    let isAllDay, isCancelled, isOrganizer, responseRequested: Bool
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case id, createdDateTime, lastModifiedDateTime, changeKey, categories
        case transactionID = "transactionId"
        case originalStartTimeZone, originalEndTimeZone
        case iCalUID = "iCalUId"
        case reminderMinutesBeforeStart, isReminderOn, hasAttachments, subject, bodyPreview, importance, sensitivity, isAllDay, isCancelled, isOrganizer, responseRequested
        case seriesMasterID = "seriesMasterId"
        case showAs, type, webLink
        case onlineMeetingURL = "onlineMeetingUrl"
        case isOnlineMeeting, onlineMeetingProvider, allowNewTimeProposals, isDraft, hideAttendees, recurrence, onlineMeeting, responseStatus, body, start, end, location, locations, attendees, organizer
    }
}
...
struct Location: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case uniqueIDType = "uniqueIdType"
